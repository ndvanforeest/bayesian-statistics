...
#+subtitle: Recursion, a tree class
...
** Simplest recursion: Stationary distribution for the M/M/1 queue
...
** Slightly harder: Fibonacci sequence
...
When using recursion, /always/ think about the stopping condition. If you mis a corner case, your code will keep running. Often it will claim more and more memory, and your computer will crash.
...
A reminder: this code will crash if you call ~F(0.5)~ (why?), or ~F(-1)~. In good code you should check the input.
