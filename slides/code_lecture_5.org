...
The imports for a random forest are mostly the same as for the bag. As you'll see in a minute, I can make a random forest by subclassing a bag. (Classes are so elegant, once you get the hang of it.)
