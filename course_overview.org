...
|    2 |        3 | 4.4                        | avv      |
|      |        4 | coding                     | nvf      |
|    3 |        5 | 5.1-5.3, 5.5-5.7, 6.1-6.2  | avv      |
|      |        6 | coding                     | nvf      |
|    4 |        7 | coding                     | nvf      |
|    5 |        8 | 7.1, 7.2, 7.4-7.6, 7.8     | avv      |
|      |        9 | coding                     | nvf      |
|    6 |       10 | Ch 8                       | avv      |
|      |       11 | coding/writing report      | nvf      |
|    7 |       11 | Ch 8                       | avv      |
|      |       12 | coding/writing report      | nvf      |
|    8 |       13 | No lectures/writing report | avv/nvf  |
|      |       14 | No lecture/writing report  | avv/nvf  |
...
Students in groups of three write a report.
...
- Cover page: title, student names and student numbers, course code, year
- Core:
  - Intro, problem description
  - Literature, what published work is suitable for the problem.
...
- Appendix with code whose core parts are documented. (Don't include long tables with data, because we (=avv and nvf) will just skip them.)

The report is due at Friday June 4 23h59 (last Friday of the lecture weeks).

** Review of other report
Each group has to review the report of an other group. The review should discuss the quality of
- The writing/presentation of the report, use of graphs, tables.
- Data analysis
- Assessement of the used model and suitability
- Findings and conclusions: are the claims based on the analysis, are the claims convincing.
Due date: Wednesday after the due date of the report.
